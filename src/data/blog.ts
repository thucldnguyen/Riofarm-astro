...
export const blogPosts: BlogPost[] = [
  {
    slug: 'gian-hang-tet',
    title: 'Ghé Thăm Gian Hàng Tết Rio Macca — Mua Trực Tiếp Tại Cơ Sở',
    category: 'Tin tức',
    excerpt: 'Dịp Tết Nguyên Đán, Rio Macca mở gian hàng trưng bày tại cơ sở Lâm Hà để khách hàng có thể ghé thăm và mua sắm trực tiếp.',
    image: '/blogs/tet-booth.jpg',
    alt: 'Gian hàng Tết Rio Macca tại cơ sở Lâm Hà',
    link: '/blog/gian-hang-tet',
